...
root.title("CPS Lab")
mimg=PhotoImage(file="carpn.png")
...
tab4 = Frame(tabControl,background="black")
...
def FromDb(q):
	dbdb = pymysql.connect(user='root', passwd='root', 
		host='localhost', db='ev', charset='utf8')
...
#	print(res)
	...
	plt.savefig('tabsave.png')	# 일단 save
	plt.close()

	gimg = PhotoImage(file="tabsave.png")	# 저장된 그림의 로드
...
#	print(res)
	...
	plt.savefig('tabsave.png')
	plt.close()

	gimg = PhotoImage(file="tabsave.png")
